...
export default function ExplorerActivityView({filteredActivities}) {
    ...
    return workingDirectory ?
        <>
            <ExplorerList currentDirectory = {workingDirectory.name} filteredActivities={filteredActivities} />
            <Center mt={20}>
