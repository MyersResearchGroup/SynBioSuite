...
export default function CollectionInfo() {
    ...
    }, [getAuthToken, sbhLoginOpen, updateCollections, clearLoginSuppression, workflows]);
    ...
    }, [selectedRepo, dataSBH, sbhLoginOpen, dispatch, setDataPrimarySBH, clearLoginSuppression, workflows]);
    ...
    return (
        <>
            ...
            <Group position="center">
                ...
                ) : <Button onClick={() => workflows.loginToSBH()} color="blue">Login</Button>}
